...
- - -
<p align="center">
  <img src="https://github.com/29-min/yolov5--PNP/blob/main/detection_data/11%3A28/detection_statistics_graph(1).png" width="400" height="300"/>
  <img src="https://github.com/29-min/yolov5--PNP/blob/main/detection_data/11%3A28/people.png" width="400" height="300"/>
...
- - -
## 이규민
cv가 다방면에 활용이 되고 있어 언젠가 깊게 공부해 보고 싶었는데, 마침 좋은 조원들을 만나 교내 복잡도를 분석하는 프로젝트를 진행하게 되었다. 센서나 모터 제어를 위주로 하던 로봇과 다르게 학습 모델은 상당히 복잡한 부분이 있었다.
